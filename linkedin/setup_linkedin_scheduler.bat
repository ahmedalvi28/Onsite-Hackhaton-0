...
REM Create task - runs daily at 9 AM
schtasks /create /tn "LinkedIn Daily Automation" /tr "\"%PYTHON_EXE%\" \"%PYTHON_SCRIPT%\" --once --task full" /sc daily /st 09:00 /ru "%USERNAME%" /rl highest
